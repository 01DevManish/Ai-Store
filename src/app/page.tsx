  ...
  return (
    <>
      ...
      <main className="container mx-auto min-h-screen max-w-6xl p-4 sm:p-6 lg:p-8 bg-black-500">
        ...
        <h2 className="mt-10 mb-8 text-2xl sm:text-3xl lg:text-4xl font-bold text-center text-white">
          Testing Modals
        </h2>
       <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
  <a href="https://text2-image-hazel.vercel.app/">
    <button className=" mt-10 w-full px-4 py-2 border-2 border-blue-500 text-blue-500 rounded-md hover:bg-blue-500 hover:text-white transition duration-200">
      Text to Image
    </button>
  </a>
  <a href="https://text-generative.vercel.app/">
    <button className=" mt-10 w-full px-4 py-2 border-2 border-blue-500 text-blue-500 rounded-md hover:bg-blue-500 hover:text-white transition duration-200">
      Text to Text
    </button>
  </a>
  <a href="https://text-to-audio-olive.vercel.app/">
    <button className=" mt-10 w-full px-4 py-2 border-2 border-blue-500 text-blue-500 rounded-md hover:bg-blue-500 hover:text-white transition duration-200">
      Text to Audio
    </button>
  </a>
